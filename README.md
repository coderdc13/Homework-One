...
### How is the company funded? How much funding has metamask.io received?
It seems that metamask.io is funded by ConsenSys. Based on https://everipedia.org/wiki/lang_en/kumavis, Davis joined ConsenSys in 2015. However, metamask.io was started in 2016, based on https://www.owler.com/company/metamask. If these two accounts are true, then metamask.io was founded as a part of ConsenSys. There is less information on funding for metamask than there is financial data for HTB; the student author can find absolutely nothing on funding for metamask.io.
## Business Activities
### What specific financial problem is the company or project trying to solve?
Ostensibly, metamask.io may serve as a wallet for ethereum and other cryptocurrencies. However, metamask.io has been described as a gateway for decentralized applications (https://www.optimum-web.com/what-is-metamask/). Supposedly, metamask.io can serve as a bridge between average use of the internet and the world of decentralized applications (https://www.optimum-web.com/what-is-metamask/).
### What is the company’s intended customer? Is there any information about the market size of this set of clients? What solution does this company offer that their competitors do not or cannot offer (what is the unfair advantage that this bank utilizes)?
The intended customer is the bitcoin user and trader. Data is at https://consensys.net/. Metamask is supposed to distinguish itself through its relationship with Infura, according to https://www.bitdegree.org/tutorials/metamask-wallet-review/#MetaMaskvsMyEtherWallet. 
### Which technologies is this company currently using, and how is this company implementing them?
One can state that metamask.io leverages blockchain technology and technology from ethereum development. This technology comes from the Satoshi Nakamoto cryptocurrency treatise (https://bitcoin.org/en/bitcoin-paper). One may possible understand metamask.io as the application of the ideas of Satoshi Nakamoto.
## Landscape
### In what domain of the financial industry is the company?
Easily, one can state that metamask.io exists in the domain of cryptocurrency. A main service of metamask.io is service as an ethereum hot storage container. In addition, metamask.io would be able to store other cryptocurrencies.
### What have been the major trends and innovations of this domain over the last five to ten (5-10) years?
One could argue that the major trend in this domain over the last year is the rush by banks to dominate blockchain technology. Blockchain technology, specifically the nature of the blockchain as a decentralized ledger, could easily threaten banking services by digital 'elimination of the middle man.' As a result, major banks have invested large sums of money in order to dominate blockchain research, use, and advantages for themselves (https://thenextweb.com/hardfork/2019/08/15/blockchain-investment-banking-industry-cryptocurrency-bitcoin-dlt/).
### What are the other major companies in this domain?
According to https://www.owler.com/company/metamask, the major competitors are magic (https://magic.link/), bitski (https://www.bitski.com/), and portis (https://www.portis.io/).
## Results
### What has been the business impact of this company so far?
Most likely, metamask.io would assert that their company makes purchasing cryptocurrency and leveraging decentralized applications easier.
### What are some of the core metrics that companies in this domain use to measure success? How is your company performing, based on these metrics?
Most likely, the major metric that companies in this domain would use is the number of downloads. Also, another metric would be the use. Definitely, another metric would be the amount of money transferred. According to https://consensys.net/, metamask.io has been downloaded more than four million (4,000,000) times.
### How is your company performing relative to competitors in the same domain?
...
## Works Cited
https://www.owler.com/company/metamask
https://www.linkedin.com/company/metamask
https://www.linkedin.com/company/metamask
https://www.youtube.com/watch?v=7HDVgjQnNdM
https://www.youtube.com/watch?v=Gz7yVz2iYK8
https://www.reddit.com/r/ethereum/comments/3x97rg/aaron_davis_explains_the_differences_between/
